...
* Nicolas Lazcano [__Scum Master__] (nicolas.lazcano@estudiantes.uv.cl)
* Angelo De La Rivera [__Product Owner__] (angelo.delarivera@estudiantes.uv.cl)
* Sebastian Rojas [__Developer__] (sebastian.rojas@estudiantes.uv.cl)
* Rodrigo Sances [__Developer__] (rodrigo.sances@estudiantes.uv.cl) 
...
# Figma 
Link: https://www.figma.com/make/L7kJczFfb03QMJUuH8S2vK/Fire-Alert-App?p=f&t=Gcc1H9smyc8RL5ly-0&fullscreen=1
...
# Atributos:
__Rendimiento__: Alertas eficientes y de respuesta rapida.
__Disponibilidad__: Uso de Localizador siempre disponible y GPS siempre operativo.
__Escalabilidad__: Capaz de manejar todas las alertas y solicitudes de rescates sin que reducir el rendimiento de la app.
__Recuperabilidad__: Recibir las señales de rescate cada vez que sea posible.
